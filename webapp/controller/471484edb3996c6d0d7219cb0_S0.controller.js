sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.manageBlanketAgreements.controller.471484edb3996c6d0d7219cb0_S0", {
		...
		_onObjectListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("2ec593d6aa6c33440d7244345_S5", oBindingContext, fnResolve, "");
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForB1757d990ce68d950d7241a94S4();

						oModel = this.getView().getModel();
						var oNewBindingContext = oModel.createEntry("CustomerSet", {
							properties: oNewEntityInstance
						});

						this.doNavigate("b1757d990ce68d950d7241a94_S4", oNewBindingContext, fnResolve);
					}
				}.bind(this)).catch(function(err) {
					if (err !== undefined) {
						MessageBox.error(err.message);
		...
		onInit: function() {
			...
			this.oRouter.getTarget("471484edb3996c6d0d7219cb0_S0").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
